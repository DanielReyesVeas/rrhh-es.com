  ...
  <div class="page">
        ...
        <table id="libro">
            <thead>
                <tr>                    
                    <th class="border2" rowspan="2">TRABAJADOR</th>   
                    ...
                    @if($datos->conceptos['sueldo_liquido'])<th class="border2" rowspan="2">ALCANCE LÍQUIDO</th>@endif
                    <tr class="border">
                        ...
                        @if($datos->conceptos['impuesto'])<th>IMP. ÚNICO</th>@endif        
                ...
                @foreach($datos->liquidaciones as $dato)
                    <tr class="border3">
                        ...
                        @if($datos->conceptos['sueldo_liquido'])
                            <td class="border1" rowspan="2">{{ Funciones::formatoPesos($dato->sueldo_liquido) }}</td>
                        @endif
                        <tr class="border">
                            <td>
            ...
            <tfoot>
                <tr>
                    <td class="border1" rowspan="2"><b>TOTAL GENERAL:</b></td>
                    @if($datos->conceptos['sueldo_base'])
                    ...
                    @endif 
                    @if($datos->conceptos['sueldo_liquido'])
                        <td class="border1" rowspan="2"><b>{{ Funciones::formatoPesos($datos->totales['totalSueldoLiquido']) }}</b></td>
                    @endif 
                    <tr class="border">
                        @if($datos->conceptos['dias_trabajados'])
